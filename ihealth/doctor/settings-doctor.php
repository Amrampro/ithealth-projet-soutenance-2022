							...
							<form>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="Doctor-name">Nom Complèt</label>
										<input type="text" value="<?= $med['nom'] . ' ' . $med['prenom'] ?>" class="form-control" placeholder="Doctor name" id="Doctor-name">
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" value="<?= Specialite::column($db, $med['idspecialite'], "nom") ?>" placeholder="Specialization" class="form-control" id="specialization">
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" value="+237 <?= $med['tel'] ?>" placeholder="Phone" class="form-control" id="phone">
									</div>
									<div class="form-group col-md-6">
										<label for="email">Email</label>
										<input type="email" value="<?= $med['email'] ?>" placeholder="email" class="form-control" id="Email">
									</div>
									<div class="form-group col-md-6">
