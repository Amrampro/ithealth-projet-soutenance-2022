                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 proclinic-box-shadow">
                            <h3 class="widget-title">Choisissez le medecin que vous souhaiteriez prendre en rdv</h3>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $stat ?></td>
                                                <td>
                                                    <a href="add-appointment.php?id=<?= $medecin['idmedecin'] ?>" class="btn btn-outline-success"><i class="fa fa-plus" aria-hidden="true"></i> Choisir</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
